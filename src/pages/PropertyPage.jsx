                ...
                <div className="flex flex-row  bg-nak-dark-gray h-full rounded-2xl">
                    <div className="flex flex-col p-10 w-[30vw]">
                        ...
                        <div className="flex flex-col bg-nak-light-gray rounded-2xl mt-20">
                            <div className="text-8xl text-white mx-auto mt-20">10K</div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-2xl text-white mt-10">2 BHK Builder Floor For Sale in Salasar Luxury Floors,Neharpar, Faridabad </div>
